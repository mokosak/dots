...
static const char *fonts[]          = { "SpaceMono Nerd Font Mono:size=14", "SpaceMono Nerd Font Mono:size=14" };
static const char dmenufont[]       = "SpaceMono Nerd Font Mono:size=20";
//background color
...
//Top bar second color (blue) and active window border color ORANGE=="#f59542" PURPLE=="bd93f9"
static const char col_cyan[]        = "#3cacff";
